...
namespace ConsoleApp._2___Types
{
    ...
    //Atributos são formas poderos de adicionar metadados a aplicação
    ...
    public static class ReflectionClass
    {
        ...
        public static void TestarReflectionCodeDOM()
        {
        ...
        //Definição do atributo, se é classe, metodo, se permite mais de 1
